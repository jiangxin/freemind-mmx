...
public class FileTileCache implements TileCache {
	...
	/* (non-Javadoc)
	 * @see org.openstreetmap.gui.jmapviewer.interfaces.TileCache#getTile(org.openstreetmap.gui.jmapviewer.interfaces.TileSource, int, int, int)
	 */
...
//			System.out.println("Loading tile " + tileKey);
	...
	/* (non-Javadoc)
	 * @see org.openstreetmap.gui.jmapviewer.interfaces.TileCache#addTile(org.openstreetmap.gui.jmapviewer.Tile)
	 */
	...
	public void saveTile(Tile pTile) {
		String tileKey = getTileKey(pTile.getSource(), pTile.getXtile(), pTile.getYtile(), pTile.getZoom());
		File file = getFile(tileKey);
		if(! file.exists()) {
			try {
