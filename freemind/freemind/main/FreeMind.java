 ...
 */
/*$Id: FreeMind.java,v 1.32.14.28.2.117 2008-07-09 20:01:01 christianfoltin Exp $*/
...
public class FreeMind extends JFrame implements FreeMindMain {
	...
	protected static final VersionInformation VERSION = new VersionInformation("0.9.0 Beta 19");
	...
	private void loadMaps(final String[] args, ModeController pModeController) {
		...
		for (int i = 0; i < args.length; i++) {
			...
			if (fileArgument
				...
				// fin = ;
				try {
					pModeController.load(Tools.fileToUrl(new File(fileArgument)));
					fileLoaded = true;
