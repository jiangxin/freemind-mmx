 ...
 */
/*$Id: StylePatternFrame.java,v 1.1.2.2 2006-02-26 00:30:10 christianfoltin Exp $*/
...
public class StylePatternFrame extends JPanel implements TextTranslator {
    ...
    public void setPattern(StylePattern pattern) {
        ...
        mSetEdgeWidth.setValue((!pattern.getAppliesToEdge()) ? FALSE_VALUE
                : TRUE_VALUE);
        mEdgeWidth.setValue(transformEdgeWidth(pattern.getEdgeWidth()));
        mSetEdgeStyle.setValue((pattern.getEdgeStyle() == null) ? FALSE_VALUE
                : TRUE_VALUE);
        mEdgeStyle.setValue((pattern.getEdgeStyle()==null)?EDGE_STYLES[0]:pattern.getEdgeStyle());
    }

    private String transformEdgeWidth(int edgeWidth) {
        int index = 0;
        switch (edgeWidth) {
        case EdgeAdapter.WIDTH_PARENT:
            index = 0;
            break;
        case EdgeAdapter.WIDTH_THIN:
            index = 1;
            break;
        case 1:
        case 2:
        ...
        return EDGE_WIDTHS[index];
    }

    private int transformStringToWidth(String value) {
        ...
        return ((Integer) transformator.get(value)).intValue();
    }
    ...
    public StylePattern getResultPattern() {
        ...
        if(mSetEdgeWidth.getValue() == TRUE_VALUE) {
            ...
            pattern.setEdgeWidth(EdgeAdapter.DEFAULT_WIDTH);
        }
        return pattern;
    }
    ...
    public static void main(String[] args) {
        ...
        final StylePatternFrame stylePatternFrame = new StylePatternFrame(
                new TextTranslator() {
                    ...
                    public String getText(String pKey) {
                        System.out.println(pKey+"=" + pKey.replaceAll("PatternDialog.", ""));
